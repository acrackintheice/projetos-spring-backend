...
//De acordo com: http://stackoverflow.com/questions/12074756/integrating-spring-security-with-ajax-calls
public class JSFRedirectStrategy implements RedirectStrategy {
     ...
     * <p>
     * If <tt>contextRelative</tt> is set, the redirect value will be the value after the request context path. Note that this will result
     * in the loss of protocol information (HTTP or HTTPS), so will cause problems if a redirect is being performed to change to HTTPS, for
     * example.
     */
