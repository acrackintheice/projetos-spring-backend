package projetostcc.service.proxy;
...
public class ProxyCAGRServiceImpl implements CAGRService {
    private final CAGRService proxy;

    public ProxyCAGRServiceImpl(CAGRService proxy) {
        this.proxy = proxy;
    }
    ...
    @Override
    public CurriculoCurso getCurriculoCurso(Integer integer) throws WebServiceException {
        return proxy.getCurriculoCurso(integer);
    }
    ...
    @Override
    public Integer getSemestreAtualCurso(Integer integer) {
        return proxy.getSemestreAtualCurso(integer);
    }
    ...
    @Override
    public List<DisciplinaCurriculo> getDisciplinasCurriculoCurso(Integer integer) throws WebServiceException {
        return proxy.getDisciplinasCurriculoCurso(integer);
    }
