...
public class ProxyCadastroPessoaServiceImpl implements CadastroPessoaService {

    private final CadastroPessoaService proxy;

    public ProxyCadastroPessoaServiceImpl(CadastroPessoaService proxy) {
        this.proxy = proxy;
    }
    ...
    @Override
    public PessoaFotoDTO getFotoPreferencialByIdPessoa(Long aLong, boolean b) throws WebServiceException {
        return proxy.getFotoPreferencialByIdPessoa(aLong, b);
    }
